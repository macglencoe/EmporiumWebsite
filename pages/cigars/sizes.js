...
const Sizes = (props) => {
  ...
  // All unique sizess, alphabetized
  const uniqueSizes = [
    ...new Set(Data.flatMap(item => item['Sizes'].map(size => size.trim())))
  ...
  return (
    <>
      <div className="catalog-container10">
        <Head>
          <title>Cigar Sizes</title>
          <meta property="og:title" content="Cigar Sizes" />
          ...
          <div className="catalog-content1 collapsed">
            ...
            <div className="catalog-container21">
              ...
              <div style={
                ...
                {uniqueSizes.sort().map((brand, index, arr) => {
                  if (brand === '') {
                    return null;
                  }
