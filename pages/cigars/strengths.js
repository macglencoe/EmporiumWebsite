  ...
  return (
    <>
      <div className="catalog-container10">
        <Head>
          <title>Cigar Strengths</title>
          <meta property="og:title" content="Cigar Strengths" />
          ...
          <div className="catalog-content1 collapsed">
            ...
            <div className="catalog-container21">
              ...
              <div style={
                ...
                {uniqueStrengths.sort().map((brand, index, arr) => {
                  if (brand === '') {
                    return null;
                  }
