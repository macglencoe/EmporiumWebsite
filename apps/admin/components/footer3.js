          ...
          <div className="footer3-content">
            <div className="footer3-links">
              ...
              >
                {props.link2 ?? (
                  <Fragment>
                    <span className="footer3-text7">Products</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="footer3-text5">Events</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link4 ?? (
                  <Fragment>
                    <span className="footer3-text6">Contact Us</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link5 ?? (
                  <Fragment>
                    <span className="footer3-text1">Visit Us</span>
                  </Fragment>
                )}
              </a>
            </div>
            ...
            <div className="footer3-row">
              <div className="footer3-footer-links">
                ...
                <span className="thq-body-small">
                  {props.cookiesLink ?? (
                    <Fragment>
                      <span className="footer3-text2">Cookies Policy</span>
                    </Fragment>
                  )}
                </span>
              </div>
